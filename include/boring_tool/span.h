//
// Created by shimu on 2025/8/15.
//

#ifndef BORING_TOOL_SPAN_H
#define BORING_TOOL_SPAN_H
#include <algorithm>
#include <string_view>
#include <type_traits>
...
inline std::string_view BytesAsStringView(Span<const uint8_t> b) {
  return std::string_view(reinterpret_cast<const char *>(b.data()), b.size());
}
}//namespace btool
#endif //BORING_TOOL_SPAN_H